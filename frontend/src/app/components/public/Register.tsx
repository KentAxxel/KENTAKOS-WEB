...
export default function Register() {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    e.preventDefault();
    try {
      const res = await fetch('http://shop.spring.informaticapp.com:2920/api/auth/register', {
        method: 'POST',
    ...
    <div className="min-h-screen flex bg-gray-50">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-gradient-to-br from-[#D62828] to-[#F77F00] overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center items-center w-full h-full text-white p-12">
          ...
          <h1 className="text-5xl font-bold mb-4 text-center">Únete a la Familia</h1>
          <p className="text-xl text-white/80 text-center max-w-md">
            Crea tu cuenta para acceder a promociones exclusivas y ordenar tus favoritos más rápido.
          </p>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12 overflow-y-auto">
        <div className="w-full max-w-md">
          ...
          {/* Form Header */}
          <div className="mb-8">
            <h2 className="text-3xl font-bold text-[#111111] mb-2">Crear Cuenta</h2>
          ...
          <form onSubmit={handleRegister} className="space-y-5">
            <div className="space-y-2">
              <label className="text-sm font-semibold text-gray-700 block">Usuario</label>
          ...
          <button
            ...
            className="w-full flex items-center justify-center space-x-2 bg-white border border-gray-200 text-gray-700 py-3 rounded-xl font-semibold hover:bg-gray-50 transition-colors shadow-sm"
          >
